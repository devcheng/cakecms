    ...
    <form action="<?php echo $this->Url->build(['plugin' => $this->request->params['plugin'], 'controller' => 'Arctypes', 'action' => 'edit', $data->id]);?>" class="pageForm" data-toggle="validate" data-reloadNavtab="ture" >
        ...
        <div class="tab-content">
                ...
                <table class="table table-condensed">
                    ...
                    <tr>
                        <td>
                            ...
                            <input type="text" name="asname" value="<?php echo $data->asname;?>" size="35" class="form-control input-nm" >
                        </td>
                    </tr>
                    <tr>
                        <td>
                    ...
                    <tr id="href" <?php if ($data->type != 5) {echo 'style="display: none;"';}?> >
                        <td>
                            <label for="name" class="control-label x85">栏目链接：</label>
                            <input type="text" name="href" placeholder="http://" value="<?php echo $data->href;?>" <?php if ($data->type == 5) {echo 'data-rule="required;url"';}?> id="input-href" size="35" class="form-control input-nm">
                            <span style="color:#ff0000;">*</span>
                        </td>
                    </tr>
                    <tr>
                        <td>
                            ...
                            <input type="text" name="keywords" value="<?php echo $data->keywords;?>" size="35" class="form-control input-nm" >
                        </td>
                    </tr>
                    <tr>
                        <td>
            ...
            <div class="tab-pane fade" id="content">
                <textarea name="content" data-toggle="kindeditor" class="j-content" style="width: 100%;height: 430px;" ><?php echo $data->content;?></textarea>
            </div>
        </div>
    </form>
</div>
